...
float rtbis(float (*func)(float), float x1, float x2, float xacc, int *count);
float rtflsp(float (*func)(float), float x1, float x2, float xacc, int *count);
float rtnewt(void (*funcd)(float, float *, float *), float x1, float x2,
	float xacc, int *count);
float rtsafe(void (*funcd)(float, float *, float *), float x1, float x2,
	float xacc, int *count);
float rtsec(float (*func)(float), float x1, float x2, float xacc, int *count);
